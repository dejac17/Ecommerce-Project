##**Ecommerce With Golang Project By Deja Clarke**
...
```json
{
  "first_name": "Deja",
  "last_name": "Clarke",
  "email": "dejac2002@gmail.com",
  "password": "ilovelinkedin",
  "phone": "+4534545435"
}
```
...
- **Cart Checkout Function and placing the order(GET REQUEST)**
  ...
  After placing the order the items have to be deleted from cart functionality added
